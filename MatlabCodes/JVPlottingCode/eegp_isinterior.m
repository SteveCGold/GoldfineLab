...
%   the angle subteneded by opts.interior_nbrs must exceed opts.interior_circfrac of a circle
...
%   (returned only if there are 3 or more neighbors), so that the tangent plane is unambiguous
%
% created on 5/7/10, JV (documentation edits 5/18/11)
%
