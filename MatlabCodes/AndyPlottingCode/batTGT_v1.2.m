function TGToutput=batTGT(varargin)
%
%called by subplotTGT as well as by subplotSpectra
%Takes in data from batCrxULT that have cutData in it
%
...
%call with TGToutput=subplotTGT(spectra1,spectra2,p-value);
%data have to be structure variable called dataCutByChannel
%
%called by subplotSpectra to run the two group test
%
...
%[] this shouldn't have two group test code in it but should just call it.
