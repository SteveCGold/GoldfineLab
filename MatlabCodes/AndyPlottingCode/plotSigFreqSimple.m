function [contiguousMoreThanFR,contiguousSigFreq]=plotSigFreqSimple(figuretitle,spectra1label, spectra2label,TGToutput, ChannelList,TGTpathname,legendon)
...
% numPlotLines=length(SrivasList);
...
%     ic=SrivasList(id);
    ...
    %     'XTick',[6:3:24],'XLim',[2 plottingRange(2)],'TickDir','out','TickLength',[0.005 0.005],'fontsize',28);
     set(gca,'YLim',[0.5 ir-1],'YTick',[],'YTickLabel',[],'XTick',[plottingRange(1):4:plottingRange(2)],'XLim',[plottingRange(1) plottingRange(2)],'TickDir','out','TickLength',[0.005 0.005],'fontsize',28);
