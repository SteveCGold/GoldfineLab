%5/2/11 AMG modification of eegplot. 1)[] check to ensure data is in rows (or
%automatically switch it with a warning), 2)[] in lines 420s have it plot
%real time info and at run time convert to real time either by giving all time stamps
%or simply adding the start time to the first number and then converting at run time
%to time , 3)[] may want to make sure it can plot along with acclerometer data using 
%children (should work already)
