function figOut = opendyfig(filename, policy, visible)
%based on openfig but for figures who I would like dynamicDateTicks
%run on opening.
%
%12/8/11 AMG
%
%modified 12/5/11 AMG to force figures to be visible: http://www.mathworks.com/matlabcentral/newsreader/view_thread/306249
%
...
if isempty(ext)
    ext = '.dyfig';
elseif ~isequal(lower(ext), '.dyfig')
    error(message('MATLAB:opendyfig:dyfigFileExpected'));
end
...
dynamicDateTicks([],[],'dd/mm');axis tight;zoom xon
