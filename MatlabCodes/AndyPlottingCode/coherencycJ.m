function [C,phi,S12,S1,S2,f,confC,phistd,Cerr]=coherencycJ(J1,J2,params,N)
% Multi-taper coherency,cross-spectrum and individual spectra - continuous process
%
%AMG 3/20/11 modified from coherencyc to take in FFT (called J) so only need to do once per
%channel. Saves time if running on a lot of channels. Called by Coheeglab.
%
% Usage:
% [C,phi,S12,S1,S2,f,confC,phistd,Cerr]=coherencycJ(data1,data2,params,N)
% Input: 
% Note units have to be consistent. See chronux.m for more information.
%       data1 (in form samples x trials) -- required
%       data2 (in form samples x trials) -- required
%       params: structure with fields tapers, pad, Fs, fpass, err, trialave
%       N: number of time points in each trial (normally determined by
%       data) AMG
%       - optional
