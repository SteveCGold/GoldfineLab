function scrollAndy(old_val)
%modified 5/8/12 AMG from downloaded code
%  scroll(old_val)
%
...
if ~isempty(clbk)
  %   scroll_clbk_indx = strmatch('scroll',clbk);%original
  scroll_clbk_indx = strncmp('scroll',clbk{1},5);%AMG modified 5/8/12 since was crashing since was a cell in a cell
end
...
set(fig_chld(clbk_indx(scroll_clbk_indx)),'callback',['scrollAndy(',num2str(val),')']);%AMG modified 5/8/12 to ensure calls this code again
