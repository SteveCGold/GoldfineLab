function [contiguousMoreThanFR,contiguousSigFreq]=plotSigFreqSimpleSrivas(figuretitle,spectra1label, spectra2label,TGToutput, ChannelList,TGTpathname,legendon)

%based on plotSigFreq but want to get rid of Fisher and spacings
%11/27/11 added decreased y-axis fontsize in case >100 channels and hard to
%read with FontSize of 18
%modified to only plot channels used in Cruse et al. 
%3/5/12 v2 modified to reorder and relabel channels for publication
...
%     SrivasList=[6    7   13   29   30   31   35   36   37   41   42   54   55   79 80   87   93  103  104  105  106  110  111  112  129]; 
    ...
    ChannelOrder=[13 29 35 7 30  36 41 31 37 42 54 6 129 55 112 111 110 106 105 104 103 80 87 93 79];
    spaces=[12 15];    
