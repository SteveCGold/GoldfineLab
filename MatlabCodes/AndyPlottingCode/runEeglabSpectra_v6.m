...
if opts.bip
    [data,ChannelList]=MakeBipolar(data,chanlocs);
...
%     if isfield(alleeg,'bipolar') && alleeg.bipolar %since ChannelList comes from makeBipolar
    ...
    save (savename,'S','f','Serr','frequencyRecorded','numChannels','numChannelsOrig','icadata','ChannelList','dataCutByChannel','params');
    fprintf('%s created\n',savename);
