...
%
%AMG - if you get more correct than expected (expected is E=n*p) then
%two-sided
%calculates the probability of getting s or more (standard 1-binocdf(s,n,p)) + the
%probability of getting E-(s-E) or fewer. So for example if p=0.5 and got
%60 right out of 100, it adds probability of 60 or more to the probability
%of 40 or less. Code also works if s<E.
%
% Inputs:
