...
%  presetaxes = [0.05 0.05 0.9 0.85]; 
presetaxes = [0.08 0.05 0.9 0.9]; %AG - this is what I changed it to, is
% very big, good for cropping for powerpoint
%presetaxes = [0.1 0.1 0.8 0.8]; %AG
