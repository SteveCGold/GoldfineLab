...
%%
% INSERT location of ica executable (LINUX ONLY)-(Should be all computers with correct 'ica_**' in functions->resources folder) for binica.m below
eeglab_p = fileparts(which('eeglab'));
if ismac, ICABINARY = fullfile(eeglab_p, 'functions', 'resources', 'ica_osx'); 
elseif ispc, ICABINARY = fullfile(eeglab_p, 'functions', 'resources', 'ica_pc'); %Not in Google Drive folder yet
elseif isunix, ICABINARY = fullfile(eeglab_p, 'functions', 'resources', 'ica_linux'); 
end
%%
try
